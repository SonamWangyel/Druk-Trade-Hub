...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundImage: "url('https://i.pinimg.com/originals/cf/57/7d/cf577d963b77a87e3a8f7f9c67f8ee40.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <header className="bg-white-500/40 text-black text-center py-4 items-center font-serif relative">
        ...
        <h1 className="text-2xl font-bold text-black">DRUK TRADE HUB</h1>
      </header>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 text-black">
        <input
          ...
          className="w-full p-2 border border-black-600 rounded-md text-black-600 bg-white"
        />
      
          <div className="mt-4">
            <button onClick={()=>router.push(`/pages/products/${name}`)}

            className="bg-blue-500 hover:bg-blue-700 text-black font-bold py-5 px-10 rounded">
      ...
      <div id="gallery" className="max-w-lg mx-auto rounded-lg overflow-hidden p-4" data-carousel="slide">
        <Carousel
          showArrows={true}
          infiniteLoop={true}
          autoPlay={true}
          ...
          showThumbs={false}
        >
          <img src="https://pbs.twimg.com/media/C6Is1JKUwAACX6t.jpg" alt="Clothing/Attires" className="max-h-80 w-auto mx-auto" />
          ...
          <img src="https://previews.agefotostock.com/previewimage/medibigoff/c99357366faae6c15451c987a546f11b/dpa-pga-256212.jpg" alt="Accessories" className="max-h-80 w-auto mx-auto" />
           ...
           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="overflow-hidden shadow rounded-lg">
              ...
              <div className="bg-cyan-100 overflow-hidden shadow rounded-lg">
                <div className="p-6">
                  ...
                  <Link href="/pages/categories/3" className="text-white bg-green-400  focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 inline-block">
                    Discover More
                  </Link>
                </div>
              </div>
              <div className="bg-cyan-100 overflow-hidden shadow rounded-lg">
                <div className="p-6">
                  ...
                  <Link href="/pages/categories/1" className="text-white bg-green-400 focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800   font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 inline-block">
                    Discover More
                  </Link>
                </div>
              </div>
              <div className="bg-cyan-100 overflow-hidden shadow rounded-lg">
                <div className="p-6">
                  ...
                  <Link href="/pages/categories/4" className="text-white bg-green-400 focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800   font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 inline-block">
                    Discover More
                  </Link>
                </div>
              </div>
              <div className="bg-cyan-100 overflow-hidden shadow rounded-lg">
                <div className="p-6 mt-4">
                  ...
                  <Link href="/pages/categories/8" className="text-white bg-green-400 focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800   font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 inline-block">
                    Discover More
                  </Link>
                </div>
              </div>
              <div className="bg-cyan-100 overflow-hidden shadow rounded-lg">
                <div className="p-6">
                  ...
                  <Link href="/pages/categories/6" className="text-white bg-green-400 focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 inline-block">
                    Discover More
                  </Link>
                </div>
              </div>
              <div className="bg-cyan-100 overflow-hidden shadow rounded-lg">
                <div className="p-6">
                  ...
                  <Link href="/pages/categories/7" className="text-white bg-green-400 focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 inline-block">
                    Discover More
                  </Link>
                </div>
              </div>
